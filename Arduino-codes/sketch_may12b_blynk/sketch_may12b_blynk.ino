...
// See the Device Info tab, or Template settingsinclude
#define BLYNK_TEMPLATE_ID           "TMPLjnoh-a-t"
#define BLYNK_DEVICE_NAME           "Quickstart Device"
#define BLYNK_AUTH_TOKEN            "fJ5uTocBrqc2E_qEXEVo1O45tFxaKjNx"
...
void voltage(){
  ...
  Serial.println("Turbidity: ");
    ...
    for(int i=0; i<800; i++)
    {
        volt += ((float)analogRead(A0)/1024)*5;
    }
    volt = volt/800;
    ...
    if(volt < 2.5){
      ...
      ntu = -1120.4*(volt*volt)+5742.3*volt-4423.8; 
    }
...
void setup()
{
  ...
  timer.setInterval(1000L, voltage);
}
